...
class Ui_Ortus(object):
    def setupUi(self, Ortus):
        ...
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(10, 20, 865, 384))
        ...
        self.label_info.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        ...
        self.text_log.setBaseSize(QtCore.QSize(0, 500))
        font = QtGui.QFont()
        font.setPointSize(8)
        self.text_log.setFont(font)
        self.text_log.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        ...
        self.verticalLayout_14.addWidget(self.button_generate_password)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.line_output_password.sizePolicy().hasHeightForWidth())
        self.line_output_password.setSizePolicy(sizePolicy)
        self.line_output_password.setReadOnly(True)
        self.line_output_password.setObjectName("line_output_password")
        self.horizontalLayout_2.addWidget(self.line_output_password)
        ...
        font = QtGui.QFont()
        font.setPointSize(10)
        self.text_passwords.setFont(font)
        ...
        self.text_passwords.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse|QtCore.Qt.TextBrowserInteraction|QtCore.Qt.TextSelectableByKeyboard|QtCore.Qt.TextSelectableByMouse)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1700, 25))
    ...
    def retranslateUi(self, Ortus):
        ...
        self.label_info.setText(_translate("Ortus", "Ortus - password manager.\n"
